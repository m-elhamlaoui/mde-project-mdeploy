...
import terraform.*; // Import your generated EMF classes.
import java.io.File;
...
public class JsonToTerraform {
    public static void main(String[] args) throws Exception {
        ...
        TerraformJson terraformData = mapper.readValue(new File("src/terraformIn/terraform-spec.json"), TerraformJson.class);
    ...
    private static void saveModelToXMI(TerraformConfiguration terraformConfig) throws Exception {
        ...
        Resource resource = resSet.createResource(URI.createFileURI("src/terraformIn/terraform.xmi"));
