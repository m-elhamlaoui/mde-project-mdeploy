...
public class TerraformSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TerraformPackage.TERRAFORM_CONFIGURATION: {
				TerraformConfiguration terraformConfiguration = (TerraformConfiguration)theEObject;
				T result = caseTerraformConfiguration(terraformConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraformPackage.RESSOURCE: {
			...
			case TerraformPackage.ATTRIBUTE: {
	 ...
	 * @generated
	 */
	public T caseTerraformConfiguration(TerraformConfiguration object) {
		return null;
	}
