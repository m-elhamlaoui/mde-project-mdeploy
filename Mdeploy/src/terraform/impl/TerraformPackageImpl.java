...
public class TerraformPackageImpl extends EPackageImpl implements TerraformPackage {
	 ...
	 * @generated
	 */
	private EClass terraformConfigurationEClass = null;
	 ...
	 * @see terraform.TerraformPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getTerraformConfiguration() {
		return terraformConfigurationEClass;
	}
	 ...
	 */
	@Override
	public EReference getTerraformConfiguration_Resources() {
		return (EReference)terraformConfigurationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getTerraformConfiguration_Variables() {
		return (EReference)terraformConfigurationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getTerraformConfiguration_Providers() {
		return (EReference)terraformConfigurationEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getTerraformConfiguration_Outputs() {
		return (EReference)terraformConfigurationEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getRessource_Attributes() {
	 ...
	 */
	@Override
	public EReference getProvider_Attributes() {
	...
	public void createPackageContents() {
		...
		terraformConfigurationEClass = createEClass(TERRAFORM_CONFIGURATION);
		createEReference(terraformConfigurationEClass, TERRAFORM_CONFIGURATION__RESOURCES);
		createEReference(terraformConfigurationEClass, TERRAFORM_CONFIGURATION__VARIABLES);
		createEReference(terraformConfigurationEClass, TERRAFORM_CONFIGURATION__PROVIDERS);
		createEReference(terraformConfigurationEClass, TERRAFORM_CONFIGURATION__OUTPUTS);
		...
		createEReference(ressourceEClass, RESSOURCE__ATTRIBUTES);
		...
		createEAttribute(providerEClass, PROVIDER__VERSION);
		createEReference(providerEClass, PROVIDER__ATTRIBUTES);
	...
	public void initializePackageContents() {
		...
		initEClass(terraformConfigurationEClass, TerraformConfiguration.class, "TerraformConfiguration", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTerraformConfiguration_Resources(), this.getRessource(), null, "resources", null, 0, -1, TerraformConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTerraformConfiguration_Variables(), this.getVariable(), null, "variables", null, 0, -1, TerraformConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTerraformConfiguration_Providers(), this.getProvider(), null, "providers", null, 0, -1, TerraformConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTerraformConfiguration_Outputs(), this.getOutput(), null, "outputs", null, 0, -1, TerraformConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRessource_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProvider_Version(), ecorePackage.getEString(), "version", null, 0, 1, Provider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProvider_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1, Provider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
