...
import InitConfig.InitConfigFactory;
 ...
 * @generated
 */
public class InitConfigPackageImpl extends EPackageImpl implements InitConfigPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see InitConfig.InitConfigPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private InitConfigPackageImpl() {
		super(eNS_URI, InitConfigFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link InitConfigPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static InitConfigPackage init() {
		if (isInited) return (InitConfigPackage)EPackage.Registry.INSTANCE.getEPackage(InitConfigPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredInitConfigPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		InitConfigPackageImpl theInitConfigPackage = registeredInitConfigPackage instanceof InitConfigPackageImpl ? (InitConfigPackageImpl)registeredInitConfigPackage : new InitConfigPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theInitConfigPackage.createPackageContents();

		// Initialize created meta-data
		theInitConfigPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theInitConfigPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(InitConfigPackage.eNS_URI, theInitConfigPackage);
		return theInitConfigPackage;
	}
	 ...
	 */
	@Override
	public EReference getProject_Tests() {
	 ...
	 */
	@Override
	public EAttribute getBuild_Params() {
