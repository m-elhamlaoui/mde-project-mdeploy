 ...
 *   <li>{@link gitlab.impl.TriggerImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TriggerImpl extends MinimalEObjectImpl.Container implements Trigger {
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GitlabPackage.TRIGGER__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GitlabPackage.TRIGGER__CONDITION:
				return getCondition();
			case GitlabPackage.TRIGGER__TYPE:
				return getType();
		}
